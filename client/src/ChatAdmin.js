    ...
    useEffect(()=>{
        ...
        const textQuery = async (text) => {
            ...
            try{
                ...
                const response = await axios.post('http://9aa7-117-205-243-54.ngrok.io/api/dialogflow/textQuery',textQueryVaraiables)
        ...
        const eventQuery = async (event) => {
            ...
            try{
                ...
                const response = await axios.post('http://9aa7-117-205-243-54.ngrok.io/api/dialogflow/eventQuery',eventQueryVaraiables)
                const content= response.data.fulfillmentMessages[0]
