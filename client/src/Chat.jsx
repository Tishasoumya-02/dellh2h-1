    ...
    useEffect(()=>{
        ...
        const textQuery = async (text) => {
            ...
            try{
                ...
                const response = await axios.post('http://778f-117-205-245-38.ngrok.io/api/dialogflow/textQuery',textQueryVaraiables)
        ...
        const eventQuery = async (event) => {
            ...
            try{
                ...
                const response = await axios.post('http://778f-117-205-245-38.ngrok.io/api/dialogflow/eventQuery',eventQueryVaraiables)
                const content= response.data.fulfillmentMessages[0]
